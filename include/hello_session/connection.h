...
namespace mytutorial { struct Connection; }


struct mytutorial::Connection : Genode::Connection<Session>, Session_client
{
	Connection(Genode::Env &env)
	:
		/* create session */
		Genode::Connection<mytutorial::Session>(env, session(env.parent(),
		                                                "ram_quota=6K")),
